...
PR_URL=$(gh pr create --title "YOLO PR $TS" --body "YOLO update for merge-helper")
gh pr merge "$PR_URL" --merge --admin
echo "Success! Checked your profile for YOLO: https://github.com/themostx?tab=achievements"
